...
В корне репозитория находится файл [Руководство по Spring Cloud Gateway](GUIDE.md), который содержит подробное архитектурное руководство по Spring Cloud Gateway, объясняющее такие концепции, как:
